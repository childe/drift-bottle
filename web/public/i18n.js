...
const I18N = {
  zh: {
    ...
    drop_submit: "投进大海",
    open_reply_label: "允许任何地方的人回复（否则只有搁浅点附近的人能回）",
    open_badge: "🌏 任何地方的人都能回信",
    only_near_hint: "只有搁浅点附近的人能回信",
    ...
    traj_popup: "{status} · 漂了 {days} 天 · {km} km",
    status_beached_short: "🏝️ 搁浅",
    view_truncated: "这片海瓶子太多，仅显示部分，放大看更多",
  ...
  en: {
    ...
    open_reply_label: "Let anyone, anywhere reply (otherwise only people near where it beaches)",
    open_badge: "🌏 Anyone can reply",
    only_near_hint: "Only people near where it beached can reply",
    ...
    traj_popup: "{status} · {days} days · {km} km",
    status_beached_short: "🏝️ Beached",
    view_truncated: "Lots of bottles here — showing some. Zoom in for more.",
