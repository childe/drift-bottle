...
const I18N = {
  zh: {
    ...
    drifting_popup: "🌊 漂流中：漂了 {days} 天、{km} km（不可捡）",
    drifting_note: "🌊 附近还有 {n} 只在漂流（不可捡）",
  ...
  en: {
    ...
    drifting_popup: "🌊 Drifting: {days} days, {km} km (view only)",
    drifting_note: "🌊 {n} more drifting nearby (can't be picked up)",
